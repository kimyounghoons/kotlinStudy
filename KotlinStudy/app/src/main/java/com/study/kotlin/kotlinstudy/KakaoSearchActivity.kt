...
import com.study.kotlin.kotlinstudy.fragments.KakaoSearchGridListFragment
...
class KakaoSearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragmentManager.beginTransaction().replace(R.id.fragment_container, KakaoSearchGridListFragment()).commitAllowingStateLoss()
    }
}